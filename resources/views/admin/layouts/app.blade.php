        ...
        <aside class="admin-sidebar">
            <div class="sidebar-header">
                ...
                <div class="sidebar-brand">
                    <span class="sidebar-brand-name">PDPT UGK</span>
            ...
            <nav class="sidebar-nav">
                ...
                <a href="{{ route('admin.akreditasi-institusi.index') }}" class="nav-item {{ request()->routeIs('admin.akreditasi-institusi.*') ? 'active' : '' }}">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="4" y="2" width="16" height="20" rx="2"/><path d="M9 22v-4h6v4"/></svg>
                    Institusi
                </a>
                ...
                <div class="nav-label">Validasi Data</div>
                <a href="{{ route('admin.jenis-masalah.index') }}" class="nav-item {{ request()->routeIs('admin.jenis-masalah.*') ? 'active' : '' }}">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"/><line x1="12" y1="9" x2="12" y2="13"/><line x1="12" y1="17" x2="12.01" y2="17"/></svg>
                    Kategori Masalah
                </a>
                <a href="{{ route('admin.pengajuan-validasi.index') }}" class="nav-item {{ request()->routeIs('admin.pengajuan-validasi.*') ? 'active' : '' }}">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/></svg>
                    Daftar Pengajuan
                </a>

                <div class="nav-label">Komitmen Mahasiswa</div>
                <a href="{{ route('admin.komitmen-mahasiswa.index') }}" class="nav-item {{ request()->routeIs('admin.komitmen-mahasiswa.*') ? 'active' : '' }}">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M22 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>
                    Riwayat Komitmen
                </a>
                ...
                <a href="{{ route('admin.hero-slide.index') }}" class="nav-item {{ request()->routeIs('admin.hero-slide.*') ? 'active' : '' }}">
