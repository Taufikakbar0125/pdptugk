...
@section('title', 'Data Akreditasi Prodi')

@section('content')
<div class="page-header" style="display: flex; justify-content: space-between; align-items: center;">
    <h1 class="page-title">Akreditasi Program Studi</h1>
    <a href="{{ route('admin.akreditasi-prodi.create') }}" class="btn" style="width: auto; padding: 10px 16px;">+ Tambah Data</a>
</div>
        ...
        <table style="width: 100%; border-collapse: collapse; text-align: left;">
            <thead>
                <tr style="background: #f1f5f9; border-bottom: 1px solid #e2e8f0;">
                    <th style="padding: 12px 20px; font-weight: 600; color: #475569; font-size: 0.875rem;">Fakultas / Prodi</th>
                    ...
                    <th style="padding: 12px 20px; font-weight: 600; color: #475569; font-size: 0.875rem;">No Sertifikat</th>
            ...
            <tbody>
                ...
                <tr style="border-bottom: 1px solid #f1f5f9;">
                    ...
                    <td style="padding: 12px 20px; font-size: 0.875rem;">{{ $item->no_sertifikat }}</td>
                    <td style="padding: 12px 20px; font-size: 0.875rem;">{{ $item->status }}</td>
                    <td style="padding: 12px 20px; text-align: right;">
                        <div style="display: inline-flex; gap: 8px;">
                            <a href="{{ route('admin.akreditasi-prodi.edit', $item->id) }}" style="color: #2563eb; text-decoration: none; font-size: 0.875rem; font-weight: 500;">Edit</a>
                            <form action="{{ route('admin.akreditasi-prodi.destroy', $item->id) }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus data ini?')">
                                @csrf
                                @method('DELETE')
                ...
                @empty
                <tr>
                    <td colspan="6" style="padding: 20px; text-align: center; color: #64748b; font-size: 0.875rem;">Belum ada data akreditasi prodi.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
