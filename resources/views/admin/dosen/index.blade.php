        ...
        <table style="width: 100%; border-collapse: collapse; text-align: left;">
            <thead>
                <tr style="background: #f1f5f9; border-bottom: 1px solid #e2e8f0;">
                    ...
                    <th style="padding: 12px 20px; font-weight: 600; color: #475569; font-size: 0.875rem;">Fakultas</th>
                    <th style="padding: 12px 20px; font-weight: 600; color: #475569; font-size: 0.875rem;">NIP / NIDN</th>
            ...
            <tbody>
                ...
                <tr style="border-bottom: 1px solid #f1f5f9;">
                    ...
                    <td style="padding: 12px 20px; font-size: 0.875rem;">{{ $item->fakultas }}</td>
                    <td style="padding: 12px 20px; font-size: 0.875rem;">
                        <div style="color: #475569;">NIP: {{ $item->nip ?? '-' }}</div>
                        <div style="color: #475569;">NIDN: {{ $item->nidn ?? '-' }}</div>
                    </td>
                    <td style="padding: 12px 20px; font-size: 0.875rem;">
                    ...
                    <td style="padding: 12px 20px; text-align: right;">
                        <div style="display: inline-flex; gap: 8px;">
                            <a href="{{ route('admin.dosen.edit', $item->id) }}" style="color: #2563eb; text-decoration: none; font-size: 0.875rem; font-weight: 500;">Edit</a>
                ...
                @empty
                <tr>
                    <td colspan="6" style="padding: 20px; text-align: center; color: #64748b; font-size: 0.875rem;">Belum ada data dosen.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
