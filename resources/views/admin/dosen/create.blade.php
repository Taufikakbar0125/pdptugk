        ...
        <form action="{{ route('admin.dosen.store') }}" method="POST">
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px; margin-bottom: 16px;">
                <div>
                    ...
                    <input type="text" name="kode_pt" value="{{ old('kode_pt') }}" style="width: 100%; padding: 10px; border: 1px solid #cbd5e1; border-radius: 6px;">
                </div>
                <div>
                    <label style="display: block; margin-bottom: 8px; font-weight: 500; font-size: 0.875rem;">Nama PT</label>
                    <input type="text" name="nama_pt" value="{{ old('nama_pt') }}" style="width: 100%; padding: 10px; border: 1px solid #cbd5e1; border-radius: 6px;">
                </div>
            </div>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px; margin-bottom: 16px;">
                <div>
                    ...
                    <input type="text" name="fakultas" value="{{ old('fakultas') }}" placeholder="Contoh: Fakultas Teknik" style="width: 100%; padding: 10px; border: 1px solid #cbd5e1; border-radius: 6px;">
                </div>
                <div>
                    <label style="display: block; margin-bottom: 8px; font-weight: 500; font-size: 0.875rem;">Prodi/Jurusan</label>
                    <input type="text" name="prodi_jurusan" value="{{ old('prodi_jurusan') }}" placeholder="Contoh: Teknik Informatika" style="width: 100%; padding: 10px; border: 1px solid #cbd5e1; border-radius: 6px;">
                </div>
            </div>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px; margin-bottom: 16px;">
                <div>
                    ...
                    <input type="text" name="tempat_lahir" value="{{ old('tempat_lahir') }}" style="width: 100%; padding: 10px; border: 1px solid #cbd5e1; border-radius: 6px;">
                </div>
                <div>
                    <label style="display: block; margin-bottom: 8px; font-weight: 500; font-size: 0.875rem;">Tanggal Lahir</label>
                    <input type="date" name="tanggal_lahir" value="{{ old('tanggal_lahir') }}" style="width: 100%; padding: 10px; border: 1px solid #cbd5e1; border-radius: 6px;">
                </div>
            </div>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px; margin-bottom: 16px;">
                <div>
                    ...
                    <input type="text" name="nuptk" value="{{ old('nuptk') }}" style="width: 100%; padding: 10px; border: 1px solid #cbd5e1; border-radius: 6px;">
                </div>
                <div>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 16px; margin-bottom: 16px;">
                ...
                <div>
                    ...
                    <input type="text" name="nik" value="{{ old('nik') }}" style="width: 100%; padding: 10px; border: 1px solid #cbd5e1; border-radius: 6px;">
                </div>
                <div>
                    <label style="display: block; margin-bottom: 8px; font-weight: 500; font-size: 0.875rem;">TMMD</label>
                    <input type="text" name="tmmd" value="{{ old('tmmd') }}" style="width: 100%; padding: 10px; border: 1px solid #cbd5e1; border-radius: 6px;">
                </div>
            </div>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px; margin-bottom: 16px;">
                ...
                <div>
                    ...
                    <select name="ikatan_kerja" style="width: 100%; padding: 10px; border: 1px solid #cbd5e1; border-radius: 6px; font-family: inherit;">
                        ...
                        <option value="Tetap" {{ old('ikatan_kerja') == 'Tetap' ? 'selected' : '' }}>Tetap</option>
                        <option value="Tidak Tetap" {{ old('ikatan_kerja') == 'Tidak Tetap' ? 'selected' : '' }}>Tidak Tetap</option>
                        <option value="Kontrak" {{ old('ikatan_kerja') == 'Kontrak' ? 'selected' : '' }}>Kontrak</option>
                    </select>
                </div>
            </div>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px; margin-bottom: 16px;">
                <div>
                    ...
                    <select name="status_keaktifan" style="width: 100%; padding: 10px; border: 1px solid #cbd5e1; border-radius: 6px; font-family: inherit;">
                        ...
                        <option value="Non Aktif" {{ old('status_keaktifan') == 'Non Aktif' ? 'selected' : '' }}>Non Aktif</option>
                        <option value="Pensiun" {{ old('status_keaktifan') == 'Pensiun' ? 'selected' : '' }}>Pensiun</option>
                ...
                <div>
                    ...
                    <select name="pendidikan_terakhir" style="width: 100%; padding: 10px; border: 1px solid #cbd5e1; border-radius: 6px; font-family: inherit;">
                        ...
                        <option value="Sp-1" {{ old('pendidikan_terakhir') == 'Sp-1' ? 'selected' : '' }}>Sp-1</option>
                        <option value="Sp-2" {{ old('pendidikan_terakhir') == 'Sp-2' ? 'selected' : '' }}>Sp-2</option>
                        <option value="Profesi" {{ old('pendidikan_terakhir') == 'Profesi' ? 'selected' : '' }}>Profesi</option>
                    </select>
                </div>
            </div>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px; margin-bottom: 16px;">
                <div>
                    ...
                    <input type="text" name="tahun_masuk" value="{{ old('tahun_masuk') }}" placeholder="Contoh: 2010" style="width: 100%; padding: 10px; border: 1px solid #cbd5e1; border-radius: 6px;">
                </div>
                <div>
                    <label style="display: block; margin-bottom: 8px; font-weight: 500; font-size: 0.875rem;">Tahun Lulus</label>
                    <input type="text" name="tahun_lulus" value="{{ old('tahun_lulus') }}" placeholder="Contoh: 2015" style="width: 100%; padding: 10px; border: 1px solid #cbd5e1; border-radius: 6px;">
                </div>
            </div>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 16px; margin-bottom: 16px;">
                ...
                <div>
                    ...
                    <input type="text" name="jabatan" value="{{ old('jabatan') }}" placeholder="Contoh: Lektor" style="width: 100%; padding: 10px; border: 1px solid #cbd5e1; border-radius: 6px;">
                </div>
            </div>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px; margin-bottom: 16px;">
                <div>
                    ...
                    <input type="text" name="jabatan_awal" value="{{ old('jabatan_awal') }}" placeholder="Contoh: Asisten Ahli" style="width: 100%; padding: 10px; border: 1px solid #cbd5e1; border-radius: 6px;">
                </div>
                <div>
                    <label style="display: block; margin-bottom: 8px; font-weight: 500; font-size: 0.875rem;">TMT Jabatan Awal</label>
                    <input type="date" name="tmt_jabatan_awal" value="{{ old('tmt_jabatan_awal') }}" style="width: 100%; padding: 10px; border: 1px solid #cbd5e1; border-radius: 6px;">
                </div>
            </div>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px; margin-bottom: 16px;">
                <div>
                    ...
                    <input type="text" name="jabatan_terakhir" value="{{ old('jabatan_terakhir') }}" placeholder="Contoh: Lektor" style="width: 100%; padding: 10px; border: 1px solid #cbd5e1; border-radius: 6px;">
                </div>
                <div>
                    <label style="display: block; margin-bottom: 8px; font-weight: 500; font-size: 0.875rem;">TMT Jabatan Terakhir</label>
                    <input type="date" name="tmt_jabatan_terakhir" value="{{ old('tmt_jabatan_terakhir') }}" style="width: 100%; padding: 10px; border: 1px solid #cbd5e1; border-radius: 6px;">
                </div>
            </div>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px; margin-bottom: 16px;">
                <div>
                    ...
                    <input type="text" name="pangkat_terakhir" value="{{ old('pangkat_terakhir') }}" placeholder="Contoh: Penata Muda Tk. I (III/b)" style="width: 100%; padding: 10px; border: 1px solid #cbd5e1; border-radius: 6px;">
                </div>
                <div>
                    <label style="display: block; margin-bottom: 8px; font-weight: 500; font-size: 0.875rem;">TMT Pangkat Terakhir</label>
                    <input type="date" name="tmt_pangkat_terakhir" value="{{ old('tmt_pangkat_terakhir') }}" style="width: 100%; padding: 10px; border: 1px solid #cbd5e1; border-radius: 6px;">
                </div>
            </div>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px; margin-bottom: 16px;">
                <div>
                    ...
                    <input type="text" name="masa_kerja_gol_tahun" value="{{ old('masa_kerja_gol_tahun') }}" placeholder="Contoh: 10" style="width: 100%; padding: 10px; border: 1px solid #cbd5e1; border-radius: 6px;">
                </div>
                <div>
                    <label style="display: block; margin-bottom: 8px; font-weight: 500; font-size: 0.875rem;">Masa Kerja Gol Bulan</label>
                    <input type="text" name="masa_kerja_gol_bulan" value="{{ old('masa_kerja_gol_bulan') }}" placeholder="Contoh: 6" style="width: 100%; padding: 10px; border: 1px solid #cbd5e1; border-radius: 6px;">
                </div>
            </div>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px; margin-bottom: 16px;">
                <div>
                    ...
                    <input type="text" name="jenis_sertifikasi" value="{{ old('jenis_sertifikasi') }}" placeholder="Contoh: Serdos" style="width: 100%; padding: 10px; border: 1px solid #cbd5e1; border-radius: 6px;">
                </div>
                <div>
                    <label style="display: block; margin-bottom: 8px; font-weight: 500; font-size: 0.875rem;">Tahun Sertifikasi</label>
                    <input type="text" name="tahun_sertifikasi" value="{{ old('tahun_sertifikasi') }}" placeholder="Contoh: 2020" style="width: 100%; padding: 10px; border: 1px solid #cbd5e1; border-radius: 6px;">
                </div>
            </div>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px; margin-bottom: 24px;">
                <div>
                    ...
                    <input type="text" name="nomor_sertifikasi" value="{{ old('nomor_sertifikasi') }}" style="width: 100%; padding: 10px; border: 1px solid #cbd5e1; border-radius: 6px;">
                </div>
                <div>
                    <label style="display: block; margin-bottom: 8px; font-weight: 500; font-size: 0.875rem;">SK Sertifikasi</label>
                    <input type="text" name="sk_sertifikasi" value="{{ old('sk_sertifikasi') }}" style="width: 100%; padding: 10px; border: 1px solid #cbd5e1; border-radius: 6px;">
                </div>
            </div>
