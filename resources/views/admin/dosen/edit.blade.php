    ...
    <div class="card-body">
        ...
        <form action="{{ route('admin.dosen.update', $dosen->id) }}" method="POST">
            ...
            <div style="margin-bottom: 16px;">
                ...
                <input type="text" name="fakultas" value="{{ old('fakultas', $dosen->fakultas) }}" style="width: 100%; padding: 10px; border: 1px solid #cbd5e1; border-radius: 6px;" required>
            </div>
            ...
            <div style="margin-bottom: 16px;">
                ...
                <input type="text" name="jabatan" value="{{ old('jabatan', $dosen->jabatan) }}" placeholder="Contoh: Asisten Ahli" style="width: 100%; padding: 10px; border: 1px solid #cbd5e1; border-radius: 6px;">
            </div>
