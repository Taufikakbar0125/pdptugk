...
@section('title', 'Tambah Data Tendik')

@section('content')
<div class="page-header">
    <h1 class="page-title">Tambah Data Tendik</h1>
</div>
    ...
    <div class="card-body">
        ...
        <form action="{{ route('admin.tendik.store') }}" method="POST">
            ...
            <div style="margin-bottom: 16px;">
                ...
                <input type="text" name="unit_kerja" value="{{ old('unit_kerja') }}" style="width: 100%; padding: 10px; border: 1px solid #cbd5e1; border-radius: 6px;" required>
            </div>
            ...
            <div style="margin-bottom: 16px;">
                ...
                <input type="text" name="jabatan" value="{{ old('jabatan') }}" style="width: 100%; padding: 10px; border: 1px solid #cbd5e1; border-radius: 6px;">
            </div>
