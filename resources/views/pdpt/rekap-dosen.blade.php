...
<head>
  ...
  <title>Rekapitulasi Dosen — PDPT UGK</title>
  <meta name="description" content="Rekapitulasi data dosen Universitas Gunung Kidul berdasarkan status kepegawaian">
...
<body>
  ...
  @include('pdpt.partials.navbar', ['activePage' => 'rekap-dosen'])

  <!-- ── BREADCRUMB ── -->
  <div class="breadcrumb-bar">
    <div class="breadcrumb-left">
      <h1 class="breadcrumb-title">Rekapitulasi</h1>
      <span class="breadcrumb-sub">Rekapitulasi Dosen</span>
    </div>
    <div class="breadcrumb-nav">
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="m3 9 9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>
      <a href="/pdpt/home">Home</a>
      <span>›</span>
      <span>Rekapitulasi Dosen</span>
    </div>
  </div>
    ...
    <div class="rekap-stats">
      <div class="rekap-stat blue">
        ...
        <div class="rekap-stat-info">
          ...
          <span class="rekap-stat-value" id="rdStatPns">0</span>
        </div>
      </div>
      <div class="rekap-stat amber">
        ...
        <div class="rekap-stat-info">
          ...
          <span class="rekap-stat-value" id="rdStatCpns">0</span>
        </div>
      </div>
      <div class="rekap-stat red">
        ...
        <div class="rekap-stat-info">
          ...
          <span class="rekap-stat-value" id="rdStatKontrak">0</span>
        </div>
      </div>
      <div class="rekap-stat green">
        <div class="rekap-stat-icon">
        ...
        <div class="rekap-stat-info">
          <span class="rekap-stat-label">Tetap Non PNS</span>
          <span class="rekap-stat-value" id="rdStatTetap">0</span>
        </div>
      </div>
      <div class="rekap-stat purple">
        ...
        <div class="rekap-stat-info">
          <span class="rekap-stat-label">Total Dosen</span>
          <span class="rekap-stat-value" id="rdStatTotal">0</span>
        </div>
      </div>
    </div>
    ...
    <div class="rekap-charts">
      ...
      <div class="rekap-chart-card">
        ...
        <div class="rekap-chart-body bar-wrap">
          <canvas id="chartRekapDosen"></canvas>
        </div>
      </div>
      ...
      <div class="rekap-chart-card">
        ...
        <div class="rekap-chart-body">
          <canvas id="chartRekapDosenPie"></canvas>
        </div>
      </div>
    </div>
    ...
    <div class="rekap-table-section">
      <div class="rekap-table-header">
        <div class="rekap-table-title">
          ...
          Rekapitulasi Dosen per Fakultas
        </div>
        <button class="btn-export" onclick="exportRekapTable()">
      ...
      <div class="rekap-table-wrap">
        <table class="rekap-table">
          ...
          <tbody id="rekapDosenTableBody"></tbody>
        </table>
      </div>
    </div>
  ...
  <script>
    window.DB_REKAP_DOSEN = @json($data);
  </script>
